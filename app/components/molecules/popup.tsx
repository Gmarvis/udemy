...
const Popup: React.FC<Props> = ({ handleClose, children }: Props) => {
  return (
    <div className="fixed bg-black opacity-1 w-full h-full top-0 left-0">
      <div
        ...
        className="w-[70%] relative bg-white rounded p-5 border overflow-auto shadow md:w-[40%] max-h-fit  mx-auto mt-[250px]"
        >
        <span
          onClick={() => handleClose()}
