...
const Slide: React.FC<propsType> = ({ img, title, mainTitle }) => {
  return (
    <div className="outline-none border-none relative max-[700px]:flex max-[698px]:flex-col-reverse max-[700px]:h-[100%]">
      <div className="border border-slate-50 lg:bg-white w-1/3 absolute  left-[30px] md:left-[70px] sm:max-w-[350px] top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4 p-4 sm:p-0 rounded-lg sm:rounded-none max-[700px]:relative">
