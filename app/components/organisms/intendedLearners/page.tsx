...
export default function IntendedLearners({ }: Props) {
  return (
    <div className="py-8 px-20 ">
        <h1 className="font-bold text-slate-700 text-3xl mb-8 mt-4">Intended Learners</h1>
      ...
      <p className='max-w-4xl'>List the required skills, experience, tools or equipment learners should have prior to taking your course.
      ...
      <p className='max-w-4xl'>Write a clear description of the <a href="/#" className="underline decoration-blue-500 text-blue-700">intended learners </a> for your course who will find your course content valuable.
