...
const GotoCart = ({
  ...
  const responsiveDiv = (
    <div className="flex flex-col items-start justify-between my-6 mt-6">
      <div className="flex gap-2 item-start mb-4">
        <BsCheckCircle
          className="bg-tahiti text-white text-xl mr-1 rounded-full border-0 mt-3 outline-none w-10 h-10"
          // size={50}
        />
      ...
      <div className=" w-full py-2 px-10 bg-ctitle text-white flex justify-center items-center">
        <button
          className="w-fit-content  bg-ctitle text-white "
          onClick={gotocart}
        >
          {" "}
          <h5>Go to cart</h5>
  ...
  return (
    <div className="  flex flex-col py-2 px-3 mr-0 ">
      <div className="flex justify-between w-full">
        ...
        <button
          onClick={closeDialog}
          className="text-2xl bg-opacity-0 border-0 outline-none"
        >
          X
        </button>
      </div>
      ...
      <div className="listofFrequentlyBought border px-2 md:py-6 md:px-3 bg-white/100 ">
        ...
        <div className="flex flex-row items-center item-center justify-between p-8 ">
          ...
          <button
            className="w-fit-content md:p-4 py-3 px-3 bg-violt text-white "
