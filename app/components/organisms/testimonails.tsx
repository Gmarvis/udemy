...
const Testimonials: React.FC<Props> = ({ className }) => {
  const settings = {
    dots: false,
    infinite: false,
    speed: 500,
                ...
                <div key={testimonial.id} className="max-w-3xl mx-auto">
                  <div className="bg-white border border-gray-300 p-6 mr-2">
                    ...
                    <div className="gap-4 flex items-center pt-4 pb-2">
                      ...
                      <p className="mt-4 text-gray-600 pb-5">
                        {testimonial.name}
                      </p>
                    </div>
                    ...
                    <a
                      ...
                      className="text-blue-700 flex items-center border-t border-gray-300 pt-4 font-bold text-sm"
                    >
