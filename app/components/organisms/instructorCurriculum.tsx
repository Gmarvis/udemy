  ...
  return (
    <div className="pb-20">
      ...
      <div className="flex justify-between py-6 px-14">
        ...
        <button className="px-6 py-4 mt-4 font-bold border border-black">
          Bulk Uploader
        </button>
      </div>
      ...
      <div className="border mx-14 mb-4 border-black bg-gray2 p-4 sm:mx-4 lg:mx-8 xl:mx-12">
        {sections.map((section) => (
          <h3 key={section.id} className="flex items-center p-2 mb-8 font-bold">
            ...
            <div className="flex items-center space-x-1">
              <BsTrash
                className="cursor-pointer mr-2 text-base"
                onClick={() => {
        ...
        <div className="border border-black px-3 py-2 bg-white ml-8 justify-between items-center flex">
          <div>
            <h3 className="flex items-center hover:bg-gray2 p-2">
              {" "}
        ...
        {isDropdownOpen && !showVideo && (
          <div className="border border-black px-3 py-2 bg-white mb-4 ml-8 justify-between items-center flex border-t-0">
            <button className="px-3 py-2 mt-2 bg-white flex items-center text-black text-sm font-bold hover:bg-gray border border-black">
        ...
        {showVideo && (
          <div className="border border-black px-3 py-2 bg-white mb-4 ml-8 justify-between items-center border-t-0">
            {isAddingVideo ? (
              <div>
                <button
                  className="flex border-gray w-full mb-2 border-b-small font-bold"
                  onClick={() => setIsAddingVideo(false)}
                >
                  Upload
                </button>
                {loading && <p className="text-purple">loading...</p>}
                <input
                  type="file"
                  onChange={handleFileUpload}
                  className="border border-black mt-2 cursor-pointer px-4 py-2"
                />
                {videoUrl ? (
                  <p className="text-xs text-green py-2">
                ...
                <div className="flex justify-center">
                  ...
                  <div className="px-14 sm:px-4 lg:px-8 xl:px-12">
                    ...
                    >
                      ...
                      <p className="bg-gray items-center text-xs p-1 flex justify-center">
                        video
                      </p>
                    </div>
                  </div>
        ...
        <div className="items-center ml-8">
          <button className="px-4 py-2 mt-2 bg-white flex text-black font-bold hover:bg-gray border border-black">
            <BsPlus className="text-2xl" /> Curriculum item
          </button>
        </div>
      </div>
