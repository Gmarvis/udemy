...
export default function CourseStructure({ }: Props) {
	return (
		<div className="p-4 w-screen text-base max-w-5xl">
			<h1 className="font-bold text-slate-700 text-3xl mb-8">Course Structure</h1>
			<p className='border-b border-gray-500'></p>

			<div className='flex bg-gray-200 text-lg mb-6 p-8'>
			...
			<h2 className='font-bold mb-6 mt-8 text-2xl'>Tips</h2>
